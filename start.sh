#!/bin/bash
# Quick Start Script for Fraud Sentinel Agent with Gemini AI
# Run this after adding your GEMINI_API_KEY to backend/logic/.env
...
if [ ! -d "backend" ] || [ ! -d "frontend" ]; then
    ...
    echo "   cd /path/to/fraud-sentinel-agent"
    exit 1
fi

echo "Step 1: Checking Gemini Integration..."
cd backend/logic
if [ -f "verify_gemini.py" ]; then
