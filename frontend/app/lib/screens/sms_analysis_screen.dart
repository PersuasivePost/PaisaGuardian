                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Extracted Data
                      if (_result!['extracted_urls'] != null &&
                          (_result!['extracted_urls'] as List).isNotEmpty) ...[
                        SizedBox(height: 16),
                        Text(
                          '🔗 Extracted URLs:',
                          style: AppTextStyles.headline3,
                        ...
                        SizedBox(height: 8),
                        ...(_result!['extracted_urls'] as List)
                            .map(
                              (url) => Padding(
                                padding: EdgeInsets.only(bottom: 4),
                                child: Text(
                      ...
                      if (_result!['extracted_phone_numbers'] != null &&
                          (_result!['extracted_phone_numbers'] as List)
                              .isNotEmpty) ...[
                        SizedBox(height: 16),
                        Text(
